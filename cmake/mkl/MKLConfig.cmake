...
if (NOT TARGET MKL::MKL)
    ...
    if (NOT DEFINED ${CMAKE_FIND_PACKAGE_NAME}_VERSION)
        ...
        set(MKL_ROOT_PATCH_VERSION ${CMAKE_MATCH_1})
        set(MKL_ROOT_VERSION ${MKL_ROOT_MAJOR_VERSION}.${MKL_ROOT_UPDATE_VERSION}.${MKL_ROOT_PATCH_VERSION})
        set(${CMAKE_FIND_PACKAGE_NAME}_VERSION ${MKL_ROOT_VERSION} CACHE STRING "oneMKL version")
        set(MKL_VERSION ${MKL_ROOT_VERSION})
    endif ()
    ...
    if (INTEL_COMPILER AND (ENABLE_BLAS95 OR ENABLE_LAPACK95))
        list(APPEND MKL_INCLUDE "${MKL_ROOT}/mkl/${MKL_ARCH}/${MKL_INTERFACE}")
    endif ()
