macro(erl_config_libtorch)
    ...
    if (ERL_USE_LIBTORCH)
        ...
        if (NOT DEFINED CMAKE_CUDA_ARCHITECTURES)
            # Set a default architecture if none is specified
            set(CMAKE_CUDA_ARCHITECTURES native)
        endif ()
    endif ()
endmacro()

macro(erl_link_libtorch target)
    if (ERL_USE_LIBTORCH)
...
macro(erl_link_libtorch_python target)
    if (ERL_USE_LIBTORCH)
        get_filename_component(TORCH_LIBRARIES_DIR "${Torch_DIR}/../../../lib" ABSOLUTE)
        target_link_libraries(${target} PRIVATE "${TORCH_LIBRARIES_DIR}/libtorch_python.so")
    endif ()
endmacro()
